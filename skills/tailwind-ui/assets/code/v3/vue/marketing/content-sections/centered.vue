<template>
  <div class="bg-white px-6 py-32 lg:px-8 dark:bg-gray-900">
    <div class="mx-auto max-w-3xl text-base/7 text-gray-700 dark:text-gray-300">
      ...
      <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl dark:text-white">JavaScript for beginners</h1>
      ...
      <div class="mt-10 max-w-2xl text-gray-600 dark:text-gray-400">
        ...
        <h2 class="mt-16 text-pretty text-3xl font-semibold tracking-tight text-gray-900 dark:text-white">From beginner to expert in 3 hours</h2>
      ...
      <div class="mt-16 max-w-2xl text-gray-600 dark:text-gray-400">
        <h2 class="text-pretty text-3xl font-semibold tracking-tight text-gray-900 dark:text-white">Everything you need to get up and running</h2>
