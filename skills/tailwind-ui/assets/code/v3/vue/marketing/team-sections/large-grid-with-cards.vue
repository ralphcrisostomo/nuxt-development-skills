  ...
  <div class="bg-white py-24 sm:py-32 dark:bg-gray-900">
    <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
      <div class="mx-auto max-w-2xl">
        <h2 class="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl dark:text-white">Meet our team</h2>
      ...
      <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-8">
        <li v-for="person in people" :key="person.name" class="rounded-2xl bg-gray-100 px-8 py-10 dark:bg-gray-800">
          <img class="mx-auto size-48 rounded-full outline outline-1 -outline-offset-1 outline-black/5 md:size-56 dark:outline-white/10" :src="person.imageUrl" alt="" />
