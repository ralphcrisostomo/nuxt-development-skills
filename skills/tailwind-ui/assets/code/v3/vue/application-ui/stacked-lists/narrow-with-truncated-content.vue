<template>
  <ul role="list" class="divide-y divide-gray-100 dark:divide-white/5">
    <li v-for="comment in comments" :key="comment.id" class="flex gap-x-4 py-5">
      <img class="size-12 flex-none rounded-full bg-gray-50 dark:bg-gray-800 dark:outline dark:outline-1 dark:-outline-offset-1 dark:outline-white/10" :src="comment.imageUrl" alt="" />
      <div class="flex-auto">
