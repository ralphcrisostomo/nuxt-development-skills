      ...
      <dl class="flex w-full flex-none justify-between gap-x-8 sm:w-auto">
        <div class="flex -space-x-0.5">
          ...
          <dd v-for="commenter in discussion.commenters" :key="commenter.id">
            <img class="size-6 rounded-full bg-gray-50 outline outline-2 outline-white dark:bg-gray-800 dark:outline-gray-900" :src="commenter.imageUrl" :alt="commenter.name" />
          </dd>
        </div>
