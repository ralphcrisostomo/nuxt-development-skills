                  ...
                  <template v-for="day in days" :key="day.dateTime">
                    <tr class="text-sm/6 text-gray-900 dark:text-white">
                      <th scope="colgroup" colspan="3" class="relative isolate py-2 font-semibold">
                        ...
                        <div class="absolute inset-y-0 right-full -z-10 w-screen border-b border-gray-200 bg-gray-50 dark:border-white/10 dark:bg-white/[0.025]"></div>
                        <div class="absolute inset-y-0 left-0 -z-10 w-screen border-b border-gray-200 bg-gray-50 dark:border-white/10 dark:bg-white/[0.025]"></div>
                      </th>
                    </tr>
                    <tr v-for="transaction in day.transactions" :key="transaction.id">
                      <td class="relative py-5 pr-6">
                        ...
                        <div class="absolute bottom-0 right-full h-px w-screen bg-gray-100 dark:bg-white/5"></div>
