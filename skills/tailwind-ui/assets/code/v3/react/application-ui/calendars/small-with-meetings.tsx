    ...
    <div>
      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-16">
        <div className="mt-10 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
          ...
          <div className="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm shadow ring-1 ring-gray-200 dark:bg-white/15 dark:shadow-none dark:ring-white/15">
            {days.map((day) => (
              <button
                key={day.date}
                type="button"
          ...
          {meetings.map((meeting) => (
            <li key={meeting.id} className="relative flex gap-x-6 py-6 xl:static">
              <img
                ...
                className="size-14 flex-none rounded-full dark:outline dark:outline-1 dark:-outline-offset-1 dark:outline-white/10"
              />
              <div className="flex-auto">
                ...
                <dl className="mt-2 flex flex-col text-gray-500 xl:flex-row dark:text-gray-400">
                  ...
                  <div className="mt-2 flex items-start gap-x-3 xl:ml-3.5 xl:mt-0 xl:border-l xl:border-gray-400/50 xl:pl-3.5 dark:xl:border-gray-500/50">
                    <dt className="mt-0.5">
