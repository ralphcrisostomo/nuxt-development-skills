  ...
  return (
    <div className="inline-flex rounded-md shadow-sm dark:shadow-none">
      ...
      <Menu as="div" className="relative -ml-px block">
        <MenuButton className="relative inline-flex items-center rounded-r-md bg-white px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-10 dark:bg-white/10 dark:ring-gray-700 dark:hover:bg-white/20">
