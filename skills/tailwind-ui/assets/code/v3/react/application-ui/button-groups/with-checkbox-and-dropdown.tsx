    ...
    <span className="inline-flex">
      ...
      <div className="-ml-px grid grid-cols-1">
        <select
          ...
          className="col-start-1 row-start-1 w-full appearance-none rounded-r-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/10 dark:text-white dark:outline-gray-700 dark:*:bg-gray-800 dark:focus:outline-indigo-500"
        >
