        ...
        >
          {query.length > 0 && (
            <ComboboxOption
              ...
              className="cursor-default select-none px-3 py-2 text-gray-900 data-[focus]:bg-indigo-600 data-[focus]:text-white data-[focus]:outline-none dark:text-white dark:data-[focus]:bg-indigo-500"
            >
              <div className="flex items-center">
                <div className="grid size-6 shrink-0 place-items-center rounded-full bg-gray-300 dark:bg-gray-600 [[data-focus]_&]:bg-white">
                  <UserIcon
                    className="size-4 fill-white [[data-focus]_&]:fill-indigo-600 dark:[[data-focus]_&]:fill-indigo-500"
                    aria-hidden="true"
                  />
                </div>
            ...
            >
              <div className="flex items-center">
                <img
                  src={person.imageUrl}
                  alt=""
                  className="size-6 shrink-0 rounded-full bg-gray-100 outline outline-1 -outline-offset-1 outline-black/5 dark:bg-gray-700 dark:outline-white/10"
                />
