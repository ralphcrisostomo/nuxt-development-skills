          ...
          <tbody className="divide-y divide-gray-200 bg-white dark:divide-white/10 dark:bg-gray-900">
            {people.map((person) => (
              <tr key={person.email}>
                ...
                <td className="hidden whitespace-nowrap px-3 py-4 text-sm text-gray-500 sm:table-cell dark:text-gray-400">
                  {person.title}
                </td>
                <td className="hidden whitespace-nowrap px-3 py-4 text-sm text-gray-500 lg:table-cell dark:text-gray-400">
                  {person.email}
                </td>
