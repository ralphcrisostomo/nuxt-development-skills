            ...
            <tr key={item.commit}>
              <td className="py-4 pl-4 pr-8 sm:pl-6 lg:pl-8">
                <div className="flex items-center gap-x-4">
                  <img
                    ...
                    className="size-8 rounded-full bg-gray-100 dark:bg-gray-800 dark:outline dark:outline-1 dark:outline-white/10"
                  />
              ...
              <td className="hidden py-4 pl-0 pr-4 sm:table-cell sm:pr-8">
                <div className="flex gap-x-3">
                  ...
                  <div className="rounded-md bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600 outline outline-1 outline-gray-200 dark:bg-gray-700/40 dark:text-gray-400 dark:-outline-offset-1 dark:outline-white/10">
                    {item.branch}
                  </div>
                </div>
              </td>
