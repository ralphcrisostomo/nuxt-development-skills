            ...
            <table className="relative min-w-full">
              <thead className="bg-white dark:bg-gray-900">
                <tr>
                  <th
                    scope="col"
                    className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-3 dark:text-white"
                  >
                    Name
                  </th>
                  ...
                  <Fragment key={location.name}>
                    <tr className="border-t border-gray-200 dark:border-white/10">
                      <th
                        scope="colgroup"
                        colSpan={5}
                        className="bg-gray-50 py-2 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-3 dark:bg-gray-800/50 dark:text-white"
                      >
                        {location.name}
                      </th>
                    </tr>
