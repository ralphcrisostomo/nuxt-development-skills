    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
          <button
            type="button"
            className="block rounded-md bg-indigo-600 px-3 py-1.5 text-center text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:hover:bg-indigo-400 dark:focus-visible:outline-indigo-500"
          >
            Add user
          </button>
        </div>
        ...
        <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <div className="group/table relative">
              <div className="absolute left-14 top-0 z-10 hidden h-12 items-center space-x-3 bg-white group-has-[:checked]/table:flex sm:left-12 dark:bg-gray-900">
                <button
                  type="button"
                ...
                <tbody className="divide-y divide-gray-200 bg-white dark:divide-white/10 dark:bg-gray-900">
                  {people.map((person) => (
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap py-4 pr-3 text-sm font-medium text-gray-900 group-has-[:checked]:text-indigo-600 dark:text-white dark:group-has-[:checked]:text-indigo-400">
                        {person.name}
                      </td>
