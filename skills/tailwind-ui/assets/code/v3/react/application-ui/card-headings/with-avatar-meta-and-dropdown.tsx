      ...
      <div className="flex space-x-3">
        <div className="shrink-0">
          <img
            ...
            className="size-10 rounded-full bg-gray-50 dark:bg-gray-800 dark:outline dark:outline-1 dark:-outline-offset-1 dark:outline-white/10"
          />
        </div>
        ...
        <div className="flex shrink-0 self-center">
          <Menu as="div" className="relative inline-block text-left">
            <MenuButton className="relative flex items-center rounded-full text-gray-400 outline-offset-[6px] hover:text-gray-600 dark:hover:text-white">
            ...
            >
              <div className="py-1">
                <MenuItem>
                  <a
                    href="#"
                    className="flex px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:text-gray-900 data-[focus]:outline-none dark:text-gray-200 dark:data-[focus]:bg-white/5 dark:data-[focus]:text-white"
                  >
