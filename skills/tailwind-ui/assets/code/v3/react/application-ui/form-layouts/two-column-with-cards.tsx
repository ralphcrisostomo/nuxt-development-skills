  ...
  return (
    <div className="divide-y divide-gray-900/10 dark:divide-white/10">
      <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-10 md:grid-cols-3">
        ...
        <form className="bg-white shadow-sm outline outline-1 outline-gray-900/5 sm:rounded-xl md:col-span-2 dark:bg-gray-800/50 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  <div className="flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 dark:bg-white/5 dark:outline dark:outline-1 dark:-outline-offset-1 dark:outline-gray-600 dark:focus-within:outline-indigo-500">
                    <div className="shrink-0 select-none text-base text-gray-500 sm:text-sm/6 dark:text-gray-300">
                      workcation.com/
                    </div>
                    <input
                      id="username"
