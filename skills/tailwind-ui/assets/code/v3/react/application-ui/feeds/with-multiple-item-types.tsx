                  ...
                  <>
                    <div className="relative">
                      <img
                        ...
                        className="flex size-10 items-center justify-center rounded-full bg-gray-400 outline outline-1 -outline-offset-1 outline-black/5 ring-8 ring-white dark:outline-white/10 dark:ring-gray-900"
                      />

                      <span className="absolute -bottom-0.5 -right-1 rounded-tl bg-white px-0.5 py-px dark:bg-gray-900">
                        ...
                        <span className="mr-0.5">
                          {activityItem.tags.map((tag) => (
                            <Fragment key={tag.name}>
                              <a
                                href={tag.href}
                                className="inline-flex items-center gap-x-1.5 rounded-full px-2 py-1 text-xs font-medium text-gray-900 ring-1 ring-inset ring-gray-200 dark:bg-white/5 dark:text-gray-100 dark:ring-white/10"
                              >
