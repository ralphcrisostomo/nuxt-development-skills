    ...
    <>
            ...
            {activityItem.type === 'commented' ? (
              <>
                <img
                  ...
                  className="relative mt-3 size-6 flex-none rounded-full bg-gray-50 outline outline-1 -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10"
                />
                <div className="flex-auto rounded-md p-3 ring-1 ring-inset ring-gray-200 dark:ring-white/15">
      ...
      <div className="mt-6 flex gap-x-3">
        <img
          ...
          className="size-6 flex-none rounded-full bg-gray-50 outline outline-1 -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10"
        />
