                      ...
                      <li key={person.handle}>
                        <div className="group relative flex items-center px-5 py-6">
                          <a href={person.href} className="-m-1 block flex-1 p-1">
                            <div
                              aria-hidden="true"
                              className="absolute inset-0 group-hover:bg-gray-50 dark:group-hover:bg-white/[0.025]"
                            />
                              ...
                              <span className="relative inline-block shrink-0">
                                ...
                                <span
                                  ...
                                  className={classNames(
                                    ...
                                    'absolute right-0 top-0 block size-2.5 rounded-full ring-2 ring-white dark:ring-gray-800',
                                  )}
                                />
                              </span>
                          ...
                          <Menu as="div" className="relative ml-2 inline-block shrink-0 text-left">
                            <MenuButton className="group relative inline-flex size-8 items-center justify-center rounded-full bg-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-gray-800 dark:focus-visible:outline-indigo-500">
