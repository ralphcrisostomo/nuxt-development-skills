                          ...
                          <div className="-m-1 flex">
                            <div className="inline-flex overflow-hidden rounded-lg border-4 border-white dark:border-gray-800">
                              <img
                                ...
                                className="size-24 shrink-0 bg-gray-100 outline outline-1 -outline-offset-1 outline-black/5 sm:size-40 lg:size-48 dark:bg-gray-800 dark:outline-white/10"
                              />
                            </div>
                          </div>
                        </div>
