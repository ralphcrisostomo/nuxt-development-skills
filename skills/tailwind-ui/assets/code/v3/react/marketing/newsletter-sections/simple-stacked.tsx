  ...
  return (
    <div className="bg-white py-16 sm:py-24 lg:py-32 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 className="max-w-2xl text-balance text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl dark:text-white">
        ...
        <form className="mt-10 max-w-md">
          ...
          <p className="mt-4 text-sm/6 text-gray-900 dark:text-gray-300">
            ...
            <a
              href="#"
              className="whitespace-nowrap font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300"
            >
              privacy policy
            </a>
            .
