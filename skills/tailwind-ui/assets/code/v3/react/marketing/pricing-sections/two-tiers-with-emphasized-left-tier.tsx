          ...
          >
            ...
            <a
              ...
              className={classNames(
                ...
                'mt-8 block rounded-md px-3.5 py-2.5 text-center text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 sm:mt-10 dark:focus-visible:outline-indigo-500',
              )}
            >
              Get started today
            </a>
