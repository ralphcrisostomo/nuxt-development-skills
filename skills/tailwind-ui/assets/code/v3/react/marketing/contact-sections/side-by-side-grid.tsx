      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl divide-y divide-gray-100 lg:mx-0 lg:max-w-none dark:divide-white/10">
          <div className="grid grid-cols-1 gap-10 py-16 lg:grid-cols-3">
            <div>
              <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">
                Get in touch
              </h2>
          ...
          <div className="grid grid-cols-1 gap-10 py-16 lg:grid-cols-3">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
              <div className="rounded-2xl bg-gray-50 p-10 dark:bg-gray-800/50">
                ...
                <address className="mt-3 space-y-1 text-sm/6 not-italic text-gray-600 dark:text-gray-400">
