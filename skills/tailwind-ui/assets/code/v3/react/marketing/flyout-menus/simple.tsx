...
export default function Example() {
  return (
    <Popover className="relative">
      ...
      >
        <div className="w-56 shrink rounded-xl bg-white p-4 text-sm/6 font-semibold text-gray-900 shadow-lg outline outline-1 outline-gray-900/5 dark:bg-gray-800 dark:text-white dark:shadow-none dark:outline dark:outline-1 dark:-outline-offset-1 dark:outline-white/10">
          {solutions.map((item) => (
