...
export default function Example() {
  return (
    <Popover className="relative">
      ...
      >
        <div className="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm/6 shadow-lg outline outline-1 outline-gray-900/5 dark:bg-gray-900 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
          <div className="p-4">
            {resources.map((item) => (
              <div
                key={item.name}
