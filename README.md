...
| [nuxt-visual-development](skills/nuxt-visual-development/) | Develop or modify visual elements with Playwright screenshots, Compodium component preview, and responsive/dark-mode verification. |
...
npx skills add ralphcrisostomo/nuxt-development-skills/skills/commit
```
